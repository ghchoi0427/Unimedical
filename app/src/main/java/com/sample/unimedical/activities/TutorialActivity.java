...
public class TutorialActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button btnLecture01 = findViewById(R.id.btn_lec01);
        Button btnLecture02 = findViewById(R.id.btn_lec02);
        Button btnLecture03 = findViewById(R.id.btn_lec03);
        Button btnLecture04 = findViewById(R.id.btn_lec04);
        Button btnLecture05 = findViewById(R.id.btn_lec05);
        Button btnLecture06 = findViewById(R.id.btn_lec06);
        Button btnLecture07 = findViewById(R.id.btn_lec07);
        Button btnLecture08 = findViewById(R.id.btn_lec08);
        Button btnLecture09 = findViewById(R.id.btn_lec09);
        Button btnLecture10 = findViewById(R.id.btn_lec10);
        Button btnLecture11 = findViewById(R.id.btn_lec11);
